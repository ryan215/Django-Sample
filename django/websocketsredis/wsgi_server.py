...
from websocketsredis.exceptions import WebSocketError, HandshakeError, UpgradeRequiredError
...
class WebsocketWSGIServer(object):
    ...
    def authenticate(self, request):
        # Do authentication here to check that access token is valid
        # Return false to close WebSocket
        # Note right now it just trys to get any access_token
