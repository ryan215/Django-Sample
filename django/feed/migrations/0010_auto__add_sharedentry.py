...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SharedEntry'
        db.create_table(u'feed_sharedentry', (
            (u'entry_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['feed.Entry'], unique=True, primary_key=True)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shared', to=orm['feed.Entry'])),
        ))
        db.send_create_signal(u'feed', ['SharedEntry'])


    def backwards(self, orm):
        # Deleting model 'SharedEntry'
        db.delete_table(u'feed_sharedentry')
