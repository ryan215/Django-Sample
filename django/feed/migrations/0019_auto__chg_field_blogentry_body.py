...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogEntry.body'
        db.alter_column(u'feed_blogentry', 'body', self.gf('django.db.models.fields.TextField')(max_length=1000000))

    def backwards(self, orm):

        # Changing field 'BlogEntry.body'
        db.alter_column(u'feed_blogentry', 'body', self.gf('django.db.models.fields.TextField')(max_length=1000001))
    ...
    models = {
        ...
        u'feed.blogentry': {
            ...
            'body': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '1000000'}),
        ...
        u'feed.taggedentry': {
            ...
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feed.Entry']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'feed_taggedentry_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'feed.textentry': {
        ...
        u'user_app.customuser': {
            ...
            'referred_by': ('django.db.models.fields.related.ForeignKey', [], {'default': '1L', 'related_name': "'user_reference'", 'null': 'True', 'blank': 'True', 'to': u"orm['user_app.Professional']"}),
