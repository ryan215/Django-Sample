...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Flagged'
        db.create_table(u'feed_flagged', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Entry'])),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_app.CustomUser'])),
        ))
        db.send_create_signal(u'feed', ['Flagged'])


    def backwards(self, orm):
        # Deleting model 'Flagged'
        db.delete_table(u'feed_flagged')
