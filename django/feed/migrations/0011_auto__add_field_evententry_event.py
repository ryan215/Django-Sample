...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventEntry.event'
        db.add_column(u'feed_evententry', 'event',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['schedule.Event'], unique=True, null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventEntry.event'
        db.delete_column(u'feed_evententry', 'event_id')
    ...
    models = {
        ...
        u'feed.evententry': {
            ...
            u'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Entry']", 'unique': 'True', 'primary_key': 'True'}),
            'event': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['schedule.Event']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
