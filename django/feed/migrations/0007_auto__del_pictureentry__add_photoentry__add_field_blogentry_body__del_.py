...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PhotoEntry'
        db.create_table(u'feed_photoentry', (
        ...
        db.send_create_signal(u'feed', ['PhotoEntry'])

        # Adding field 'BlogEntry.body'
        db.add_column(u'feed_blogentry', 'body',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Deleting field 'VideoEntry.video'
        db.delete_column(u'feed_videoentry', 'video')

        # Adding field 'VideoEntry.url'
        db.add_column(u'feed_videoentry', 'url',
                      self.gf('django.db.models.fields.files.FileField')(default=True, max_length=100),
                      keep_default=False)

        # Adding field 'EventEntry.allday'
        db.add_column(u'feed_evententry', 'allday',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PhotoEntry'
        db.delete_table(u'feed_photoentry')

        # Deleting field 'BlogEntry.body'
        db.delete_column(u'feed_blogentry', 'body')


        # User chose to not deal with backwards NULL issues for 'VideoEntry.video'
        raise RuntimeError("Cannot reverse this migration. 'VideoEntry.video' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VideoEntry.video'
        db.add_column(u'feed_videoentry', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100),
                      keep_default=False)

        # Deleting field 'VideoEntry.url'
        db.delete_column(u'feed_videoentry', 'url')

        # Deleting field 'EventEntry.allday'
        db.delete_column(u'feed_evententry', 'allday')
    ...
    models = {
        ...
        u'feed.blogentry': {
            ...
            'body': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
        ...
        u'feed.videoentry': {
            ...
            u'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['feed.Entry']", 'unique': 'True', 'primary_key': 'True'}),
            'url': ('django.db.models.fields.files.FileField', [], {'default': 'True', 'max_length': '100'})
        },
        u'user_app.address': {
