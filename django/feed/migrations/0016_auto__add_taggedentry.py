...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feed_taggedentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'feed_taggedentry_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Entry'])),
        ))
        db.send_create_signal(u'feed', ['TaggedEntry'])


    def backwards(self, orm):
        # Deleting model 'TaggedEntry'
        db.delete_table(u'feed_taggedentry')
