...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoEntry.img'
        db.delete_column(u'feed_videoentry', 'img')

        # Adding field 'VideoEntry.video'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'VideoEntry.img'
        raise RuntimeError("Cannot reverse this migration. 'VideoEntry.img' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VideoEntry.img'
        db.add_column(u'feed_videoentry', 'img',
