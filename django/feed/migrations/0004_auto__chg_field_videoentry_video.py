...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoEntry.video'
        db.alter_column(u'feed_videoentry', 'video', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'VideoEntry.video'
        db.alter_column(u'feed_videoentry', 'video', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
