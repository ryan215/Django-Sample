...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoEntry.url'
        db.alter_column(u'feed_videoentry', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'VideoEntry.url'
        db.alter_column(u'feed_videoentry', 'url', self.gf('django.db.models.fields.files.FileField')(max_length=100))
