...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeaturedProfessional'
        db.create_table(u'user_app_featuredprofessional', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('professional', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_app.Professional'])),
        ))
        db.send_create_signal(u'user_app', ['FeaturedProfessional'])


    def backwards(self, orm):
        # Deleting model 'FeaturedProfessional'
        db.delete_table(u'user_app_featuredprofessional')
