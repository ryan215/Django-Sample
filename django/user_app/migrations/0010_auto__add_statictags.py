...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaticTags'
        db.create_table(u'user_app_statictags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'user_app', ['StaticTags'])


    def backwards(self, orm):
        # Deleting model 'StaticTags'
        db.delete_table(u'user_app_statictags')
