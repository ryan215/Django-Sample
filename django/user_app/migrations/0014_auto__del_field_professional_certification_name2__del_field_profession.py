...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Professional.certification_name2'
        db.delete_column(u'user_app_professional', 'certification_name2')

        # Deleting field 'Professional.certification_name1'
        db.delete_column(u'user_app_professional', 'certification_name1')

        # Deleting field 'Professional.certification_number2'
        db.delete_column(u'user_app_professional', 'certification_number2')

        # Deleting field 'Professional.certification_number1'
        db.delete_column(u'user_app_professional', 'certification_number1')


    def backwards(self, orm):
        # Adding field 'Professional.certification_name2'
        db.add_column(u'user_app_professional', 'certification_name2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Professional.certification_name1'
        db.add_column(u'user_app_professional', 'certification_name1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Professional.certification_number2'
        db.add_column(u'user_app_professional', 'certification_number2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Professional.certification_number1'
        db.add_column(u'user_app_professional', 'certification_number1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
