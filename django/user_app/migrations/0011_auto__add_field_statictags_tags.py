...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticTags.tags'
        db.add_column(u'user_app_statictags', 'tags',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taggit.Tag'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticTags.tags'
        db.delete_column(u'user_app_statictags', 'tags_id')
