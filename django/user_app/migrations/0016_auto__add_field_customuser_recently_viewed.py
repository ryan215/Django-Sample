...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.recently_viewed'
        db.add_column(u'user_app_customuser', 'recently_viewed',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.recently_viewed'
        db.delete_column(u'user_app_customuser', 'recently_viewed')
    ...
    models = {
        ...
        u'user_app.customuser': {
            ...
            'recently_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
