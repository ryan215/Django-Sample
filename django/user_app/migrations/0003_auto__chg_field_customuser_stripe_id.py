...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomUser.stripe_id'
        db.alter_column(u'user_app_customuser', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CustomUser.stripe_id'
        db.alter_column(u'user_app_customuser', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=50))
