...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.connection_establish'
        db.add_column(u'user_app_customuser', 'connection_establish',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field following on 'CustomUser'
        db.delete_table(db.shorten_name(u'user_app_customuser_following'))


    def backwards(self, orm):
        # Deleting field 'CustomUser.connection_establish'
        db.delete_column(u'user_app_customuser', 'connection_establish')

        # Adding M2M table for field following on 'CustomUser'
        m2m_table_name = db.shorten_name(u'user_app_customuser_following')
    ...
    models = {
        ...
        u'user_app.customuser': {
            ...
            'connection_establish': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
