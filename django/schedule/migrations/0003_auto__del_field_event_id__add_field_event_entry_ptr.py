...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'schedule_event', u'id')

        # Adding field 'Event.entry_ptr'
        db.add_column(u'schedule_event', u'entry_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['feed.Entry'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.id'
        db.add_column(u'schedule_event', u'id',
                      self.gf('django.db.models.fields.AutoField')(default='', primary_key=True),
                      keep_default=False)

        # Deleting field 'Event.entry_ptr'
        db.delete_column(u'schedule_event', u'entry_ptr_id')
    ...
    models = {
        ...
        'schedule.event': {
            'Meta': {'object_name': 'Event', '_ormbases': [u'feed.Entry']},
