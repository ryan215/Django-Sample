...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.calendar'
        db.delete_column(u'schedule_event', 'calendar_id')


    def backwards(self, orm):
        # Adding field 'Event.calendar'
        db.add_column(u'schedule_event', 'calendar',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Calendar'], null=True, blank=True),
                      keep_default=False)
