...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoComment.user'
        db.delete_column(u'workouts_videocomment', 'user_id')

        # Adding field 'VideoComment.video'
        db.add_column(u'workouts_videocomment', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['workouts.Video']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoComment.user'
        db.add_column(u'workouts_videocomment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_app.CustomUser'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'workouts.videocomment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workouts.Video']"}),
