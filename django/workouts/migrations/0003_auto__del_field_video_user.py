...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'workouts_video', 'user_id')


    def backwards(self, orm):
        # Adding field 'Video.user'
        db.add_column(u'workouts_video', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='videos', null=True, to=orm['lef_user.Professional'], blank=True),
                      keep_default=False)
