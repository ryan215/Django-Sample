...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'workouts_video', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user_app.Professional']))

        # Changing field 'VideoComment.user'
        db.alter_column(u'workouts_videocomment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_app.CustomUser'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VideoComment.user'
        db.alter_column(u'workouts_videocomment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lef_user.LefUser'], null=True))
