...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Video'
        db.create_table(u'workouts_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='videos', null=True, to=orm['lef_user.LefUser'])),
            ...
            ('url_video', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('img', self.gf('django.db.models.fields.files.ImageField')(default='default-profile.svg', max_length=100, blank=True)),
            ('likes', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('views', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('difficulty', self.gf('django.db.models.fields.CharField')(default='beginner', max_length=30, blank=True)),
        ))
        db.send_create_signal(u'workouts', ['Video'])

        # Adding M2M table for field likes_user on 'Video'
        m2m_table_name = db.shorten_name(u'workouts_video_likes_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm[u'workouts.video'], null=False)),
            ('lefuser', models.ForeignKey(orm[u'lef_user.lefuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['video_id', 'lefuser_id'])

        # Adding model 'VideoComment'
        db.create_table(u'workouts_videocomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lef_user.LefUser'], null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
        ))
        db.send_create_signal(u'workouts', ['VideoComment'])


    def backwards(self, orm):
        # Deleting model 'Video'
        db.delete_table(u'workouts_video')

        # Removing M2M table for field likes_user on 'Video'
        db.delete_table(db.shorten_name(u'workouts_video_likes_user'))

        # Deleting model 'VideoComment'
        db.delete_table(u'workouts_videocomment')
    ...
    models = {
        ...
        u'lef_user.professional': {
            ...
            'certification_name1': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'certification_name2': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'certification_number1': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'certification_number2': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'fitness_sales_experience': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'group_fitness_experience': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'nutritionist_experience': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        u'workouts.video': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'videos'", 'null': 'True', 'to': u"orm['lef_user.LefUser']"}),
